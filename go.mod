...
replace github.com/offchainlabs/nitro => github.com/offchainlabs/nitro v0.0.0-20240802185503-77cd88d5e055
...
require (
	...
	github.com/offchainlabs/nitro v0.0.0-20240824020452-16f41be3b594
)
